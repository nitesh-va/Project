...
from .views import ActiveTeacherDetailView,InactiveTeacherDetailView
urlpatterns=[
    ...
    path('<int:emp_id>/active_inactive/', TeacherActiveStudentsView.as_view(), name='teacher_active_students'),  
